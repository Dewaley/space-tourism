...
const Destination = ({ destinations }) => {
  ...
  return (
    <div className='text-white destination-container min-h-screen overflow-x-hidden flex justify-center items-center'>
      <div className='flex md:justify-end flex-col px-4 pt-24 w-full max-w-lg md:max-w-none'>
        ...
        <div className='flex flex-col items-center'>
          ...
          <div className='flex items-center justify-center flex-col pt-16 text-lg'>
